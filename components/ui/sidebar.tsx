    ...
    >
      ...
      >
        <div
          ...
          className="bg-white/5 group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col rounded-lg group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
